            ...
            <div className="form" onSubmit={handleSend}>
                <form>
                    <div className="m-4">
                        ...
                        <input required className="bg-white focus:outline-none ring-4 ring-purple-500 focus:ring-yellow-300 rounded-lg py-2 px-4 block w-full leading-normal text-purple-700 font-semibold" type="text" id="from_name" value={form.from_name} placeholder="Your name" 
                    ...
                    <div className="m-4">
                        ...
                        <input required className="bg-white focus:outline-none ring-4 ring-purple-500 focus:ring-yellow-300 rounded-lg py-2 px-4 block w-full leading-normal text-purple-700 font-semibold" type="email" placeholder="Your email" id="from_email" value={form.from_email} onChange={e => setForm({...form, from_email: e.target.value})}/>
                    </div>
